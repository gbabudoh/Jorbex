                ...
                <nav className="flex flex-col space-y-6 overflow-y-auto">
                  ...
                  {[
                    ...
                    ...(session?.user?.userType === 'employer' ? [
                      ...
                      { href: '/employer/office', label: t('nav.office'), icon: 'M12 8v4l3 2m6-2a9 9 0 11-18 0 9 9 0 0118 0z' },
                      ...
                      { href: '/candidate/office', label: t('nav.office'), icon: 'M12 8v4l3 2m6-2a9 9 0 11-18 0 9 9 0 0118 0z' },

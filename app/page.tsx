            ...
            <div className="group relative">
              <div className="relative p-8 aspect-square flex items-center justify-center transition-all duration-500 hover:scale-[1.02]">
                ...
                <Link href="/signup?type=candidate" className="absolute bottom-12 left-1/2 transform -translate-x-1/2 z-10">
                  <div className="w-24 h-24 bg-linear-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-all duration-300 cursor-pointer animate-pulse">
              ...
              <div className="text-center mt-6 space-y-3 px-4">
                ...
                <Link href="/signup?type=candidate" className="inline-block">
                  <Button 
                    variant="primary" 
                    size="md" 
                    className="bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300 font-semibold cursor-pointer"
                  >
                    {t('hero.get_started')}
              ...
              <div className="text-center mt-6 space-y-3 px-4">
                ...
                <Link href="/signup?type=employer" className="inline-block">
                  <Button 
                    variant="primary" 
                    size="md" 
                    className="bg-linear-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300 font-semibold cursor-pointer"
                  >
                    {t('hero.start_hiring')}
                    <svg className="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link href="/signup?type=candidate" className="group">
                <Button 
                  variant="primary" 
                  size="lg" 
                  className="w-full sm:w-auto min-w-[220px] bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 text-lg font-bold px-10 py-7 cursor-pointer"
                >
              ...
              <Link href="/signup?type=employer" className="group">
                <Button 
                  variant="primary" 
                  size="lg" 
                  className="w-full sm:w-auto min-w-[220px] bg-linear-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 text-lg font-bold px-10 py-7 cursor-pointer"
                >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-4">
              {t('features.title_part1')} <span className="bg-linear-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">{t('features.title_part2')}</span>?
            </h2>

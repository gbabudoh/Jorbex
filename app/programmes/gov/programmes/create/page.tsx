...
export default function GovCreateProgrammePage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        <div className="mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Set up a new government programme or scheme.</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. National Youth Employment Scheme 2026"
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-slate-500 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Brief overview of the programme objectives and target participants..."
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-slate-500 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition resize-none"
              />
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-300 mb-1.5">City / State</label>
                <input
                  type="text"
                  value={form.city}
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition"
                />
              </div>
              <div>
            ...
            {/* Max participants */}
            <div>
              <label className="block text-sm font-semibold text-slate-300 mb-1.5">Max Participants</label>
              <input
                type="number"
                min="1"
            ...
            <div className="flex items-center justify-between bg-white/5 border border-white/10 rounded-xl px-4 py-3">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-0.5">Participants must use an invite code to enrol</p>
              </div>
              <button
                type="button"
                onClick={() => setForm({ ...form, inviteOnly: !form.inviteOnly })}
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${form.inviteOnly ? 'bg-blue-600' : 'bg-white/20'}`}
              >
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="flex-1 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm transition disabled:opacity-50"
              >
